...
class TestWSServer(TestCase, TestMixin):
    ...
    def test_poll(self):
        ...
        assert poll_json['results']['blank'] is False, 'The blank return value should be True'
        ...
        assert poll_json['results']['twelve'] is True, 'The twelve return value should be False'
